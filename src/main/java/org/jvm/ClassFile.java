...
/**
 * Created by tingyun on 2017/10/16.
 */
public class ClassFile {
    //Java虚拟机规范定义了u1、u2、u4和u8来分别表示1个字节、2个字节、4个字节和8个字节的无符号数
    /**
    public U4 magic;                            // magic              魔数
    public U2 minorVersion;                     // minor_version      主版本
    public U2 majorVersion;                     // major_version      小版本
